...
const char* serverUrl = "http://10.225.57.200:8000/api/sensor/data";  // ← IP del servidor Laravel


// ================= WIFI =================
//const char* ssid     = "COMPUTRONICA";
//const char* password = "computronic@";
//const char* serverUrl = "http://192.168.1.9:8000/api/sensor/data";  // ← IP del servidor Laravel
